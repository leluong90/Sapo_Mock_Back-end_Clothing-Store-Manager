    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                .cors(config -> config.configurationSource(request -> {
                    ...
                    cf.setAllowedOrigins(List.of("http://localhost:3000/" , "http://localhost:4200/" , "http://localhost:5173/"));
...
//                .cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(
                        (auth)->auth
                                ...
                                .permitAll()
                                .requestMatchers("/admin/statistic")
                                .permitAll()
                                .requestMatchers( HttpMethod.GET , "/admin/products" , "/admin/categories" )
                                .permitAll()
